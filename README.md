...
Rather than claiming confirmed biocontrol activity, this project focuses on evidence-based prioritization of taxa that may warrant downstream culturing, functional screening, genome sequencing, and greenhouse validation.
...
Many genera repeatedly reported in plant microbiome literature — including Pseudomonas, Massilia, Sphingomonas, and Flavobacterium — are associated with functions such as:
...
<p align="center"> <img src="results/github_figures/pca_hellinger_final.png" width="750"> </p>
Shannon Diversity Across Compartments

Quantifies alpha diversity variation across belowground niches.

<p align="center"> <img src="results/github_figures/shannon_diversity.png" width="650"> </p>
Differentially Abundant Genera

Highlights genera enriched in rhizosphere-associated communities.

<p align="center"> <img src="results/github_figures/differential_genera_bright.png" width="750"> </p>
Genus-Level Ecological Heatmap

Shows abundance patterns of dominant taxa across compartments.

<p align="center"> <img src="results/github_figures/top_genera_heatmap.png" width="750"> </p>
Trait-Informed Candidate Prioritization

Integrated ecological and functional scoring framework.

<p align="center"> <img src="results/github_figures/pgp_candidate_bubble_plot.png" width="750"> </p>
Major Findings
